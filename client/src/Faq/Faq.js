  ...
  state = {
    ...
    generalQuestions: [
      ...
      },
      {
        ...
        a: `When entering in Idle the best APR is automatically shown, and the best lending provider is already selected for you so if you decide to lend 1 SAI, you should only insert the amount and click on 'Start Lending'.
    ...
    guidelinesQuestions: [
      ...
      },
      {
        ...
        a: `We currently support SAI only, but we plan to integrate other assets as well.`
      }
    ],
    ratesQuestions: [
      {
